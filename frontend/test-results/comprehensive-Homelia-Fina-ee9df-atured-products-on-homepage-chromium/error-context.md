...
- Name: comprehensive.spec.ts >> Homelia Final Comprehensive Suite >> should display featured products on homepage
- Location: tests\e2e\comprehensive.spec.ts:45:3
...
Expected substring: "Featured Collection"
Error: strict mode violation: locator('.section-header') resolved to 6 elements:
    1) <div class="section-header text-center">…</div> aka getByText('Explore by MoodFind the')
    2) <div class="section-header text-center">…</div> aka getByText('Our PartnersAuthorized')
    3) <div class="section-header">…</div> aka getByText('Featured CollectionHandpicked textures for sophisticated interiorsView All')
    4) <div class="section-header text-center">…</div> aka getByText('By ApplicationFind the')
    5) <div class="section-header text-center">…</div> aka getByText('Why HomeliaYour trusted')
    6) <div class="section-header text-center">…</div> aka getByText('Client StoriesTrusted by')
