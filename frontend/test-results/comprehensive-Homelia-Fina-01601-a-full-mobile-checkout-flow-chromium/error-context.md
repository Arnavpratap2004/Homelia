...
- Name: comprehensive.spec.ts >> Homelia Final Comprehensive Suite >> should complete a full mobile checkout flow
- Location: tests\e2e\comprehensive.spec.ts:84:3
...
Locator: locator('.navbar-logo, .auth-logo')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('.navbar-logo, .auth-logo')
